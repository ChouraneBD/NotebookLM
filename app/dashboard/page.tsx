            ...
            <header className="h-20 bg-white/80 backdrop-blur-md sticky top-0 z-10 border-b border-gray-100 px-8 flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    <div className="relative hidden sm:block">
                        ...
                        <input
                            className="pl-10 pr-4 py-2 rounded-full border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary-blue)] w-64 transition-all"
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    <div className="flex-1 bg-gradient-to-r from-[var(--primary-blue)] to-[var(--soft-purple)] rounded-3xl p-8 text-white shadow-xl relative overflow-hidden flex flex-col justify-center min-h-[200px]">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-3xl font-bold mb-2 text-white">Ready to crush your next exam?</h3>
                        ...
                        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
                            ...
                            <div>
                                ...
                                <div className="flex items-end gap-2">
                                    <span className="text-2xl font-bold text-gray-800">12/15</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-1">
                            <div className="flex flex-col sm:flex-row items-center gap-4 p-4 border-b border-gray-50 last:border-0 hover:bg-gray-50 rounded-xl transition-colors">
                                <div className="w-14 h-14 rounded-xl bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-lg flex-shrink-0">
                                    AP
                                </div>
                                <div className="flex-1 w-full text-center sm:text-left">
                                    <h4 className="font-bold text-gray-800">AP Biology - Unit 3: Energetics</h4>
                                    <p className="text-xs text-gray-500 mb-2">Started 2 hours ago • AI Generated</p>
                                    <div className="w-full h-2 bg-gray-100 rounded-full">
                                        <div className="h-full bg-[var(--primary-blue)] rounded-full" style={{ width: '45%' }}></div>
                                    </div>
                                </div>
                                <div className="text-center sm:text-right flex-shrink-0">
                                    ...
                                    <div className="block">
                                        <button className="text-xs font-bold text-white bg-[var(--primary-blue)] hover:bg-indigo-700 px-4 py-2 rounded-lg transition-colors w-full">Resume</button>
                                    </div>
                                </div>
                            </div>

                            <div className="flex flex-col sm:flex-row items-center gap-4 p-4 hover:bg-gray-50 rounded-xl transition-colors">
                                <div className="w-14 h-14 rounded-xl bg-purple-100 flex items-center justify-center text-purple-600 font-bold text-lg flex-shrink-0">
                                    SAT
                                </div>
                                <div className="flex-1 w-full text-center sm:text-left">
                                    <h4 className="font-bold text-gray-800">SAT Math - Calculator Section</h4>
                                    <p className="text-xs text-gray-500 mb-2">Paused • Practice Mode</p>
                                    <div className="w-full h-2 bg-gray-100 rounded-full">
                                        <div className="h-full bg-purple-500 rounded-full" style={{ width: '72%' }}></div>
                                    </div>
                                </div>
                                <div className="text-center sm:text-right flex-shrink-0">
                                    <div className="text-orange-500 font-mono font-bold bg-orange-50 px-3 py-1 rounded-lg mb-1 inline-block">
                                        Paused
                                    </div>
                                    <div className="block">
                                        <button className="text-xs font-bold text-[var(--primary-blue)] border border-[var(--primary-blue)] hover:bg-indigo-50 px-4 py-2 rounded-lg transition-colors w-full">Resume</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm relative overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div className="md:col-span-3 h-64 flex items-end justify-between px-2 sm:px-8 pb-2 relative z-10 border-b border-gray-100">
                                ...
                                {/* Bar components */}
                                <div className="w-12 flex flex-col items-center gap-2 group z-10">
                                    <div className="text-xs font-bold text-[var(--primary-blue)] opacity-0 group-hover:opacity-100 transition-opacity mb-1">72%</div>
                                    <div className="w-full bg-indigo-100 rounded-t-lg relative h-32 group-hover:bg-indigo-200 transition-colors">
                                        <div className="absolute bottom-0 w-full bg-[var(--primary-blue)] rounded-t-lg" style={{ height: '72%' }}></div>
                                    </div>
                                    <span className="text-xs text-gray-500 font-medium">Mon</span>
                                </div>
                                <div className="w-12 flex flex-col items-center gap-2 group z-10">
                                    <div className="text-xs font-bold text-[var(--primary-blue)] opacity-0 group-hover:opacity-100 transition-opacity mb-1">65%</div>
                                    <div className="w-full bg-indigo-100 rounded-t-lg relative h-28 group-hover:bg-indigo-200 transition-colors">
                                        <div className="absolute bottom-0 w-full bg-[var(--primary-blue)] rounded-t-lg" style={{ height: '65%' }}></div>
                                    </div>
                                    <span className="text-xs text-gray-500 font-medium">Tue</span>
                                </div>
                                <div className="w-12 flex flex-col items-center gap-2 group z-10">
                                    <div className="text-xs font-bold text-[var(--primary-blue)] opacity-0 group-hover:opacity-100 transition-opacity mb-1">84%</div>
                                    <div className="w-full bg-indigo-100 rounded-t-lg relative h-48 group-hover:bg-indigo-200 transition-colors">
                                        <div className="absolute bottom-0 w-full bg-[var(--primary-blue)] rounded-t-lg" style={{ height: '84%' }}></div>
                                    </div>
                                    <span className="text-xs text-gray-500 font-medium">Wed</span>
                                </div>
                                <div className="w-12 flex flex-col items-center gap-2 group z-10">
                                    <div className="text-xs font-bold text-[var(--primary-blue)] opacity-0 group-hover:opacity-100 transition-opacity mb-1">50%</div>
                                    <div className="w-full bg-indigo-100 rounded-t-lg relative h-20 group-hover:bg-indigo-200 transition-colors">
                                        <div className="absolute bottom-0 w-full bg-yellow-400 rounded-t-lg" style={{ height: '50%' }}></div>
                                    </div>
                                    <span className="text-xs text-gray-500 font-medium">Thu</span>
                                </div>
                                <div className="w-12 flex flex-col items-center gap-2 group z-10">
                                    <div className="text-xs font-bold text-[var(--primary-blue)] opacity-0 group-hover:opacity-100 transition-opacity mb-1">92%</div>
                                    <div className="w-full bg-indigo-100 rounded-t-lg relative h-56 group-hover:bg-indigo-200 transition-colors">
                                        <div className="absolute bottom-0 w-full bg-[var(--soft-purple)] rounded-t-lg" style={{ height: '92%' }}></div>
                                    </div>
                                    <span className="text-xs text-gray-500 font-medium">Fri</span>
                                </div>
                                <div className="w-12 flex flex-col items-center gap-2 group z-10">
                                    <div className="text-xs font-bold text-[var(--primary-blue)] opacity-0 group-hover:opacity-100 transition-opacity mb-1">88%</div>
                                    <div className="w-full bg-indigo-100 rounded-t-lg relative h-52 group-hover:bg-indigo-200 transition-colors">
                                        <div className="absolute bottom-0 w-full bg-[var(--soft-purple)] rounded-t-lg" style={{ height: '88%' }}></div>
                                    </div>
